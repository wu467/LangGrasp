...
from graspness_implementation.utils.data_utils import get_workspace_mask, CameraInfo, create_point_cloud_from_depth_image
from graspness_implementation.knn.knn_modules import knn
import torch
from graspness_implementation.graspnetAPI.graspnetAPI.utils.xmlhandler import xmlReader
from graspness_implementation.graspnetAPI.graspnetAPI.utils.utils import get_obj_pose_list, transform_points
import argparse


parser = argparse.ArgumentParser()
parser.add_argument('--dataset_root', default='../data/dataset')
