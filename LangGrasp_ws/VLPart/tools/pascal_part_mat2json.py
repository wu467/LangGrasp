...
if __name__ == '__main__':
    ...
    parser.add_argument('--split_path', default='datasets/pascal_part/VOCdevkit/VOC2010/ImageSets/Main')
    parser.add_argument('--split', default='val.txt')
    parser.add_argument('--ann_path', default='datasets/pascal_part/Annotations_Part')
    parser.add_argument('--ann_out', default='datasets/pascal_part/val.json')
    parser.add_argument('--only_base', action='store_true')
    args = parser.parse_args()

    if args.only_base:
        PART_CATEGORIES = PASCAL_PART_BASE_CATEGORIES
    else:
        PART_CATEGORIES = PASCAL_PART_CATEGORIES
    ...
    for img_path in img_pathset:
        ...
        for obj in obj_anno:
            ...
            obj_name = 'potted plant' if obj_name == 'pottedplant' else obj_name
