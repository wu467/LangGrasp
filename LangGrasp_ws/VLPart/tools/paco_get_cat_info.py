...
if __name__ == '__main__':
    ...
    parser.add_argument("--ann", default='datasets/paco/annotations/paco_lvis_v1_train.json')
    parser.add_argument("--out", default='datasets/metadata/paco_lvis_v1_train_cat_info.json')
