...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', default='datasets/metadata/partimagenet_supercat_clip_RN50_a+cname.npy')
    ...
    super_cat_names = []
    for x in cat_names:
        if x.split(' ')[0] not in super_cat_names:
            super_cat_names.append(x.split(' ')[0])
    cat_names = [x for x in super_cat_names]
